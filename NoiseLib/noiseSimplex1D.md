Generates Simplex noise based on 1 dimensional coordinate based on simulation time. [Simplex Noise on Wikipedia](https://en.wikipedia.org/wiki/Simplex_noise)
